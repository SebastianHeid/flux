...
python -m grasp\
    ...
    --logging_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_18_s_12 \
    ...
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_18_s_12 \
    --output_name test \
    --persistent_data_loader_workers \
    --pretrained_model_name_or_path /gpfs/bwfor/work/ws/hd_om233-flux/model_flux/flux/flux1-dev.safetensors \
    --pruned_model_path /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_18/compressed_model.safetensors \
    ...
    --compress_single_blocks_new 19 24 12 22 26 31 10 20 23 29 15 25   \
