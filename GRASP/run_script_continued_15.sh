...
python -m grasp\
    ...
    --logging_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_15 \
    ...
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_15 \
    --output_name test \
    --persistent_data_loader_workers \
    --pretrained_model_name_or_path /gpfs/bwfor/work/ws/hd_om233-flux/model_flux/flux/flux1-dev.safetensors \
    --pruned_model_path /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_12/compressed_model.safetensors \
    ...
    --compress_double_blocks_new 4 7 8   \
