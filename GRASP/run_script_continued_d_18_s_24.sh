#!/bin/bash
#SBATCH --job-name=GRASP_d_18_s_12_continued
#SBATCH --output=/home/hd/hd_hd/hd_om233/SVD/flux/train_script/output/GRASP_d_18_s_12_continued.txt
#SBATCH --error=/home/hd/hd_hd/hd_om233/SVD/flux/train_script/error/GRASP_d_18_s_12_continued.txt
...
python -m grasp\
    ...
    --logging_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_18_s_24 \
    ...
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_18_s_24 \
    --output_name test \
    --persistent_data_loader_workers \
    --pretrained_model_name_or_path /gpfs/bwfor/work/ws/hd_om233-flux/model_flux/flux/flux1-dev.safetensors \
    --pruned_model_path /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_18_s_12/compressed_model.safetensors \
    ...
    --compress_single_blocks_new 3 18 27 30 28 21 33 32 36 8 14 2\
