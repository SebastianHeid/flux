#!/bin/bash
#SBATCH --job-name=GRASP_d_9
#SBATCH --output=/home/hd/hd_hd/hd_om233/SVD/flux/train_script/output/GRASP_d_9.txt
#SBATCH --error=/home/hd/hd_hd/hd_om233/SVD/flux/train_script/error/GRASP_d_9.txt
...
python -m grasp\
    ...
    --logging_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_9 \
    ...
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/GRASP/flux_comp_d_9 \
    --output_name test \
    ...
    --compress_double_blocks_new 13 14 10 12 11 16 9 15 3  \
