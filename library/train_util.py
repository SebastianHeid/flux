...
def add_KD_arguments(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--single_blocks", nargs="+", type=int, default=[], help="List of double blocks after which features should be used for loss calculation")
    parser.add_argument("--double_blocks", nargs="+", type=int, default=[], help="List of double blocks after which features should be used for loss calculation")
    parser.add_argument("--single_blocks_compress", nargs="+", type=int, default=[], help="List of double blocks after which features should be used for loss calculation")
    parser.add_argument("--double_blocks_compress", nargs="+", type=int, default=[], help="List of double blocks after which features should be used for loss calculation")
    parser.add_argument("--compress_single_blocks_new", nargs="+", type=int, default=[], help="List of double blocks after which features should be used for loss calculation")
    parser.add_argument("--compress_double_blocks_new", nargs="+", type=int, default=[], help="List of double blocks after which features should be used for loss calculation")
