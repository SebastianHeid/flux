...
def generate_image(
    ...
    prompt_name_w = prompt_name.split(".")[0]
    output_path = os.path.join(output_dir, prompt_name_w + "_" + str(seed) + ".png")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_file", type=str, default="/gpfs/lsdf02/sd23g007/datasets/MJHQ-30k/meta_data.json", help="/gpfs/lsdf02/sd23g007/datasets/MJHQ-30k/meta_data.json")
    ...
    if not args.interactive:
        ...
        for keys, value in prompt_items_list:
            ...
            print("Image name: ", prompt_name_w)
