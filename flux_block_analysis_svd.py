...
if __name__ == "__main__":
    ...
    while iteration_idx < MAX_BLOCKS_TO_REMOVE and (single_blocks_to_evaluate or double_blocks_to_evaluate):
        ...
        for s_block in single_blocks_to_evaluate:
            current_removed_single = removed_single_blocks + [s_block]
            ...
            model = modify_model(
                ...
                single_flag_attn=args.single_flag_attn, single_flag_mlp=args.single_flag_mlp, single_flag_mlp2=args.single_flag_mlp2, single_flag_mod=args.single_flag_mod,
                single_rank_mod=args.single_rank_mod, single_rank_mlp2=args.single_rank_mlp2, single_rank_attn=args.single_rank_attn, single_rank_mlp=args.single_rank_mlp,
                double_flag_img_attn=args.double_flag_img_attn, double_flag_txt_attn=args.double_flag_txt_attn, double_flag_img_mlp=args.double_flag_img_mlp,
                double_flag_txt_mlp=args.double_flag_txt_mlp, double_flag_img_mod=args.double_flag_img_mod, double_flag_txt_mod=args.double_flag_txt_mod,   
        ...
        for d_block in double_blocks_to_evaluate:
            current_removed_double = removed_double_blocks + [d_block]
            ...
            for idx_prompt, prompt in enumerate(prompts):
                ...
                generated_image_paths.append(os.path.join(output_dir_block, f"img_{idx_prompt}.png"))
                
            # Berechne Metriken
            # try:
   
            cmmd_double[d_block] = compute_cmmd(args.ref_path, args.output_dir)
            clip_double[d_block] = compute_clip(args.output_dir, args.prompt_path)
            # except Exception as e:
