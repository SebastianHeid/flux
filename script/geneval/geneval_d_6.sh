#!/bin/bash
#SBATCH --job-name=geneval_comp_d_6
#SBATCH --output=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_out/geneval_comp_d_6.txt
#SBATCH --error=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_error/geneval_comp_d_6.txt
...
python /home/hd/hd_hd/hd_om233/SVD/flux/flux_minimal_inference_geneval.py \
    ...
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/geneval/comp_d_6 \
    --n_samples 4 \
    --ckpt_path /gpfs/bwfor/work/ws/hd_om233-flux/model_flux/flux/flux1-dev.safetensors \
    --double_blocks 13 14 10 12 11 16 \
