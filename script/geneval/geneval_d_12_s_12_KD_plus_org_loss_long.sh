#!/bin/bash
#SBATCH --job-name=geneval_comp_KD_plus_org_loss_long
#SBATCH --output=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_out/geneval_comp_KD_plus_org_loss_long.txt
#SBATCH --error=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_error/geneval_comp_KD_plus_org_loss_long.txt
...
python /home/hd/hd_hd/hd_om233/SVD/flux/flux_minimal_inference_geneval.py \
    ...
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/geneval/geneval_comp_KD_plus_org_loss_long \
    --n_samples 4 \
