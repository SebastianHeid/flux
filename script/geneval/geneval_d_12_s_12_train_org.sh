#!/bin/bash
#SBATCH --job-name=geneval_comp_d_12_s_12_org
#SBATCH --output=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_out/geneval_comp_d_12_s_12_org.txt
#SBATCH --error=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_error/geneval_comp_d_12_s_12_org.txt
...
python /home/hd/hd_hd/hd_om233/SVD/flux/flux_minimal_inference_geneval.py \
    ...
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/geneval/comp_d_12_s_12_train_org \
    --n_samples 4 \
