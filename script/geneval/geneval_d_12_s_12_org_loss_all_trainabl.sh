#!/bin/bash
#SBATCH --job-name=geneval_comp_d_12_s_12_org_loss_all_trainable
#SBATCH --output=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_out/geneval_comp_d_12_s_12_org_loss_all_trainable.txt
#SBATCH --error=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_error/geneval_comp_d_12_s_12_org_loss_all_trainable.txt
...
python /home/hd/hd_hd/hd_om233/SVD/flux/flux_minimal_inference_geneval.py \
    ...
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/geneval/geneval_comp_d_12_s_12_org_loss_all_trainable \
    --n_samples 4 \
