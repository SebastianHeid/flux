#!/bin/bash
#SBATCH --job-name=cmmd
#SBATCH --output=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_out/cmmd.txt
#SBATCH --error=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_error/cmmd.txt
