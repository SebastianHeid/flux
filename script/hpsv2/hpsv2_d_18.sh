#!/bin/bash
#SBATCH --job-name=hpsv2_d_18
#SBATCH --output=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_out/hpsv2_d_18.txt
#SBATCH --error=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_error/hpsv2_d_18.txt
...
python /home/hd/hd_hd/hd_om233/SVD/flux/flux_minimal_inference_hpsv2.py \
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/hpsv2/comp_d_18 \
