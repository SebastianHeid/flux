#!/bin/bash
#SBATCH --job-name=hpsv2_d_12_s_12_org_loss_all_trainable
#SBATCH --output=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_out/hpsv2_d_12_s_12_org_loss_all_trainable.txt
#SBATCH --error=/home/hd/hd_hd/hd_om233/SVD/flux/script/std_error/hpsv2_d_12_s_12_org_loss_all_trainable.txt
...
python /home/hd/hd_hd/hd_om233/SVD/flux/flux_minimal_inference_hpsv2.py \
    --output_dir /gpfs/bwfor/work/ws/hd_om233-flux/flux/hpsv2/flux_comp_d_12_s_12_org_loss_all_trainable_50k \
